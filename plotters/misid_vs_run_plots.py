...
latex.DrawLatexNDC(0.14,0.82,"#bf{BMTF}")
# latex.DrawLatexNDC(0.14,0.74, "Reco p_{T} #geq 26 GeV")
latex.DrawLatexNDC(0.14, 0.78, "#bf{L1 Qual #geq 12}")
...
latex.SetTextSize(0.04)
latex.DrawLatexNDC(0.80,0.91,dataset_legend)
latex.DrawLatexNDC(0.14,0.82,"#bf{OMTF}")
# latex.DrawLatexNDC(0.14,0.74, "Reco p_{T} #geq 26 GeV")
latex.DrawLatexNDC(0.14,0.74, "#bf{L1 Qual #geq 12}")
latex.SetTextSize(0.045)
latex.DrawLatexNDC(0.11, 0.91, "#font[61]{CMS}")
latex.SetTextSize(0.0346)
latex.DrawLatexNDC(0.205, 0.91, "#font[52]{Internal}")
...
latex.SetTextSize(0.04)
latex.DrawLatexNDC(0.80,0.91,dataset_legend)
latex.DrawLatexNDC(0.14,0.82,"#bf{EMTF}")
# latex.DrawLatexNDC(0.14,0.74, "Reco p_{T} #geq 26 GeV")
latex.DrawLatexNDC(0.14,0.74, "#bf{L1 Qual #geq 12}")
latex.SetTextSize(0.045)
latex.DrawLatexNDC(0.11, 0.91, "#font[61]{CMS}")
...
latex.SetTextSize(0.04)
latex.DrawLatexNDC(0.80,0.91,dataset_legend)
latex.DrawLatexNDC(0.14,0.82,"#bf{uGMT}")
# latex.DrawLatexNDC(0.14,0.74, "Reco p_{T} #geq 26 GeV")
latex.DrawLatexNDC(0.14, 0.82, "#bf{L1 Qual #geq 12}")
latex.SetTextSize(0.045)
latex.DrawLatexNDC(0.11, 0.91, "#font[61]{CMS}")
latex.SetTextSize(0.0346)
latex.DrawLatexNDC(0.205, 0.91, "#font[52]{Internal}")
