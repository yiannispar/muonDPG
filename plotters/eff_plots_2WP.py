...
for wp in WPs:
    for var in vars_title:
        ...
        if var == "eta":
            ...
            leg = ROOT.TLegend(0.62,0.13,0.8,0.33)
            leg.SetFillStyle(0)
            ...
            latex.DrawLatexNDC(0.64,0.48,quality_label)
            latex.DrawLatexNDC(0.64, 0.41, pt_l1_label)
            latex.DrawLatexNDC(0.64, 0.34, pt_reco_label)
