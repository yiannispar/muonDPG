...
for var in vars_title:
    ...
    leg = ROOT.TLegend(0.64, 0.9, 0.8, 0.65)
    ...
    latex.DrawLatexNDC(0.63,0.61,"#bf{Tight L1 quality}")
...
c2.SaveAs(output_dir + "misid_TP" + key2 + ".png")
...
latex.DrawLatexNDC(0.605,0.87,"OMTF")
latex.DrawLatexNDC(0.73,0.87,"EMTF")
c2.SaveAs(output_dir + "misid_TP_l1" + key2 + ".png")
...
latex.DrawLatexNDC(0.605,0.87,"OMTF")
latex.DrawLatexNDC(0.73,0.87,"EMTF")
c2.SaveAs(output_dir + "misid_TP_difference.png")