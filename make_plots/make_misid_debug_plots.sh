############ settings #############
root_files_dir=/afs/cern.ch/user/n/nplastir/Trigger/CMSSW_13_0_3/src/muonDPG/output/out_misid/
...
python3 misid_plots_debug.py -o $output_dir -i $root_files_dir --legend "$dataset_legend" 
